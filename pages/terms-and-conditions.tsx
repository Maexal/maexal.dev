...
const TermsAndConditionsPage = (): JSX.Element => {
	...
	return (
		<>
			...
			<Main>
				<div className="px-4 py-12 pt-32 text-left md:text-center border-solid border-b-1 border-blue-200 dark:border-blue-800 bg-blue-100 dark:bg-blue-900">
				...
				<div className="relative container px-4 pt-12 pb-20 mx-auto max-w-prose bg-blue-100 dark:bg-blue-900 text-page-content">
					...
					<p className="my-2">For the purposes of these Terms and Conditions:</p>
					<ul className="my-2">
						<li>
							<p>
						...
						<li>
							<p>
								...
								Roggeveenstraat 25, 5685EC Best, The Netherlands.
							</p>
						</li>
						<li>
							<p>
					...
					<h2 className="my-8">Acknowledgment</h2>
					<p className="my-2">
					...
					<h2 className="my-8">Termination</h2>
					<p className="my-2">
					...
					<p className="my-2">Upon termination, Your right to use the Service will cease immediately.</p>
					<h2 className="my-8">Limitation of Liability</h2>
					<p className="my-2">
					...
					<h2 className="my-8">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
					<p className="my-2">
					...
					<h2 className="my-8">Governing Law</h2>
					<p className="my-2">
					...
					<h2 className="my-8">Disputes Resolution</h2>
					<p className="my-2">
					...
					<h2 className="my-8">For European Union (EU) Users</h2>
					<p className="my-2">
					...
					<h2 className="my-8">United States Legal Compliance</h2>
					<p className="my-2">
					...
					<h2 className="my-8">Severability and Waiver</h2>
					<h3 className="my-6">Severability</h3>
					<p className="my-2">
					...
					<h2 className="my-8">Translation Interpretation</h2>
					<p className="my-2">
					...
					<h2 className="my-8">Changes to These Terms and Conditions</h2>
					<p className="my-2">
						We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. If a
						revision is material We will make reasonable efforts to provide at least 30 days&apos; notice

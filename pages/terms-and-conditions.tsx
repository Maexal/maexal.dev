				...
				<div className="relative container px-4 pt-12 pb-20 mx-auto max-w-prose bg-primary-100 dark:bg-primary-900 text-page-content">
					...
					{locale === 'nl' && (
						<p className="my-6 p-3 rounded bg-red-600 text-white">
							De algemene voorwaarden zijn alleen in het Engels beschikbaar.
						</p>
					)}
					...
					<p className="text-justify my-2">For the purposes of these Terms and Conditions:</p>
					<ul className="my-2">
						<li>
						...
						<li>
							<p className="text-justify my-1">
								...
								or &quot;Our&quot; in this Agreement) refers to Maexal, Jacob Roggeveenstraat 25, 5685EC Best, The
								Netherlands.
							</p>
						</li>
						<li>
					...
					<p className="text-justify my-2">Upon termination, Your right to use the Service will cease immediately.</p>

			...
			<Main>
				...
				<div className="relative container px-4 pt-12 pb-20 mx-auto max-w-prose bg-primary-100 dark:bg-primary-900 text-page-content">
					...
					<p className="text-justify my-2">
						...
						the collection and use of information in accordance with this olicy.
					</p>
					...
					<ul className="my-2">
						...
						<li>
							<p className="text-justify my-1">
								...
								&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Maexal, Jacob
								Roggeveenstraat 25, 5684EC Best, The Netherlands.
							</p>
						</li>
						<li>
							<p className="text-justify my-1">

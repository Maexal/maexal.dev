...
const PrivacyPolicyPage = (): JSX.Element => {
	...
	return (
		<Page>
			<Head title={t('navigation.privacy-policy.capitalized-name')} />
			...
			<Main>
				...
				<div className="relative container px-4 pt-12 pb-20 mx-auto max-w-prose bg-primary-100 dark:bg-primary-900 text-page-content">
					...
					{locale === 'nl' && (
						<p className="my-6 p-3 rounded bg-red-600 text-white">
							Het privacybeleid is alleen in het Engels beschikbaar.
						</p>
					)}
					...
					<p className="text-justify my-2">
						...
						collection and use of information in accordance with this olicy.
					</p>
					<h2 className="my-8">Interpretation and Definitions</h2>
					<h3 className="my-6">Interpretation</h3>
					<p className="text-justify my-2">
						The words of which the initial letter is capitalized have meanings defined under the following conditions.
						The following definitions shall have the same meaning regardless of whether they appear in singular or in
						plural.
					</p>
					<h3 className="my-6">Definitions</h3>
					<p className="text-justify my-2">For the purposes of this Privacy Policy:</p>
					<ul className="my-2">
						<li>
						...
						<li>
							<p className="text-justify my-1">
								...
								or &quot;Our&quot; in this Agreement) refers to Maexal, Jacob Roggeveenstraat 25, 5684EC Best, The
								Netherlands.
							</p>
						</li>
						<li>
						...
						<li>
							<p className="text-justify my-1">
								<strong>Website</strong> refers to Maexal, accessible from{' '}
								<Link href={t('navigation.home.url')}>{url}</Link>
							</p>
						</li>
						<li>
							<p className="text-justify my-1">
					...
					<h2 className="my-8">Collecting and Using Your Personal Data</h2>
					<h3 className="my-6">Types of Data Collected</h3>
					...
					<ul className="my-2">
						<li>
							<p className="text-justify my-1">Email address</p>
						</li>
						<li>
							<p className="text-justify my-1">First name and last name</p>
						</li>
						<li>
							<p className="text-justify my-1">Phone number</p>
						</li>
						<li>
							<p className="text-justify my-1">Usage Data</p>
						</li>
					</ul>
					<h4 className="my-4">Usage Data</h4>
					<p className="text-justify my-2">Usage Data is collected automatically when using the Service.</p>
					<p className="text-justify my-2">
					...
					<h3 className="my-6">Tracking Technologies and Cookies</h3>
					<p className="text-justify my-2">
					...
					<ul className="my-2">
						<li>
							...
							<p className="text-justify my-1">Type: Session Cookies</p>
							<p className="text-justify my-1">Administered by: Us</p>
							<p className="text-justify my-1">
						...
						<li>
							...
							<p className="text-justify my-1">Type: Persistent Cookies</p>
							<p className="text-justify my-1">Administered by: Us</p>
							<p className="text-justify my-1">
					...
					<h3 className="my-6">Use of Your Personal Data</h3>
					<p className="text-justify my-2">The Company may use Personal Data for the following purposes:</p>
					<ul className="my-2">
						<li>
							<p className="text-justify my-1">
					...
					<p className="text-justify my-2">We may share Your personal information in the following situations:</p>
					<ul className="my-2">
						<li>
							<p className="text-justify my-1">
					...
					<h3 className="my-6">Retention of Your Personal Data</h3>
					<p className="text-justify my-2">
					...
					<h3 className="my-6">Transfer of Your Personal Data</h3>
					<p className="text-justify my-2">
					...
					<h3 className="my-6">Disclosure of Your Personal Data</h3>
					<h4 className="my-6">Business Transactions</h4>
					<p className="text-justify my-2">
					...
					<h4 className="my-6">Law enforcement</h4>
					<p className="text-justify my-2">
					...
					<h4 className="my-6">Other legal requirements</h4>
					<p className="text-justify my-2">
						The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:
					</p>
					<ul className="my-2">
						<li>
							<p className="text-justify my-1">Comply with a legal obligation</p>
						</li>
						<li>
							<p className="text-justify my-1">Protect and defend the rights or property of the Company</p>
						</li>
						<li>
							<p className="text-justify my-1">
						...
						<li>
							<p className="text-justify my-1">Protect the personal safety of Users of the Service or the public</p>
						</li>
						<li>
							<p className="text-justify my-1">Protect against legal liability</p>
						</li>
					</ul>
					<h3 className="my-6">Security of Your Personal Data</h3>
					<p className="text-justify my-2">
					...
					<h2 className="my-8">Links to Other Websites</h2>
					<p className="text-justify my-2">
					...
					<h2 className="my-8">Changes to this Privacy Policy</h2>
					<p className="text-justify my-2">
					...
					<h2 className="my-8">Contact Us</h2>
					<p className="text-justify my-2">If you have any questions about this Privacy Policy, You can contact us:</p>
					<ul className="my-2">
						<li>
							<p className="text-justify my-1">
								By email: <Link href={`mailto:${contact}`}>{contact}</Link>
							</p>
						</li>
					</ul>
				</div>

		...
		<>
			...
			<Main>
				...
				<div className="relative container px-4 pt-12 pb-20 mx-auto max-w-prose bg-blue-100 dark:bg-blue-900 text-page-content">
					...
					<p className="my-2">Usage Data is collected automatically when using the Service.</p>
					<p className="my-2">
					...
					<p className="my-2">The Company may use Personal Data for the following purposes:</p>
					<ul className="my-2">
						<li>
							<p>
					...
					<p className="my-2">We may share Your personal information in the following situations:</p>
					<ul className="my-2">
						<li>
							<p>
					...
					<p className="my-2">If you have any questions about this Privacy Policy, You can contact us:</p>
					<ul className="my-2">
						<li>
							<p>
